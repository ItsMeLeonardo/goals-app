...
//types
import type { ItemCallback, AutocompleteItem } from 'components/Pages/Share/AutocompleteTag/types'

const handler = (query: string, done: (results: AutocompleteItem[]) => void) => {
